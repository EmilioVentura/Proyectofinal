package com.android.deliveryguevara;
...
import com.android.deliveryguevara.adapters.PlaceYourOrderAdapter;
import com.android.deliveryguevara.model.Menu;
import com.android.deliveryguevara.model.RestaurantModel;
...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private void onPlaceOrderButtonClick(RestaurantModel restaurantModel) {
        if(TextUtils.isEmpty(inputName.getText().toString())) {
            ...
            inputCity.setError("INGRESE SU CIUDAD ");
            return;
            ...
            inputCardNumber.setError("INGRESE EL PIN DE SU TARJETA");
            return;
        }else if( TextUtils.isEmpty(inputCardExpiry.getText().toString())) {
            inputCardExpiry.setError("INGRESE EL VENCIMIENTO DE SU TARJETA");
            return;
        }else if( TextUtils.isEmpty(inputCardPin.getText().toString())) {
            inputCardPin.setError("INGRESE pin/cvv DE SU TARJETA ");
            return;
        }
